...
var _default = function (window, document, $, undefined) {
  ...
  $('.js-main-nav').each(function () {
    ...
    $mainNavItem.on('keydown', function (e) {
      ...
      if ((action.left || action.right) && !menuFlipped || (action.up || action.down) && menuFlipped && !open) {
        ...
        hide($openContent);
        $topLevelLink.attr('aria-expanded', 'false');
        $link.removeClass(hasFocus); // Get previous item if left arrow, next item if right arrow.
    ...
    $mainNavItem.children('button, a').on('click', function (e) {
      var $el = $(this),
          ...
          $openContent = $parent.find('.js-main-nav-content.' + openClass),
          isOpen = $content.hasClass(openClass); // mobile
...
var mixedMenuOverlay = document.querySelector(".menu-overlay");

var mfIsMobile = function mfIsMobile() {
...
document.addEventListener("DOMContentLoaded", toggleGoogleTranslate); // Move the "translate" element to the corresponding menu depending the screen size.
    ...
    if (e.key === "Escape" || e.key === "Esc" || e.code === "Escape") {
      ...
      if (openSubmenu !== document.activeElement) {
        ...
        for (var _i3 = 0; _i3 < menus.length; _i3++) {
          if (menus[_i3] === document.activeElement) {
            closeMenu();
          }
        ...
        for (var _i4 = 0; _i4 < openSubmenuItems.length; _i4++) {
          if (openSubmenuItems[_i4] === document.activeElement) {
            openSubmenu.focus();
          }
        }
      } else {
